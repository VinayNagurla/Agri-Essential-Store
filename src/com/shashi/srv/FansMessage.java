...
public class FansMessage extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		String htmlTextMessage = "" + "<html>" + "<body>"
				+ "<h2 style='color:green;'>Message to Siddhi Vinayaka AgriEssential Store</h2>" + ""
				...
				+ "</body>" + "</html>";
		String message = MailMessage.sendMessage("bodipallysridhar@gmail.com", "Fans Message | " + name + " | " + email,
				htmlTextMessage);
