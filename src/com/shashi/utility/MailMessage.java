...
public class MailMessage {
	public static void registrationSuccess(String emailId, String name) {
		...
		String htmlTextMessage = "" + "<html>" + "<body>"
				+ "<h2 style='color:green;'>Welcome to Siddhi Vinayaka AgriEssential Store</h2>" + "" + "Hi " + name + ","
				+ "<br><br>Thanks for singing up with Siddhi Vinayaka AgriEssential Store.<br>"
				...
				+ "<br><br>Our Online AgriEssential store is growing in a larger amount these days and we are in high demand so we thanks all of you for "
				...
				+ "branded products.<br><br>As a Welcome gift for our New Customers we are providing additional 10% OFF Upto 500 Rs for the first product purchase. "
				+ "<br>To avail this offer you only have "
				+ "to enter the promo code given below.<br><br><br> PROMO CODE: " + "AGRIESSENTIAL500<br><br><br>"
	...
	public static void transactionSuccess(String recipientEmail, String name, String transId, double transAmount) {
		...
		String subject = "Order Placed at Siddhi Vinayaka AgriEssential Store";
		String htmlTextMessage = "<html>" + "  <body>" + "    <p>" + "      Hey " + name + ",<br/><br/>"
				+ "      We are glad that you shop with Siddhi Vinayaka AgriEssential Store!" + "      <br/><br/>"
				...
				+ "      Come Shop Again! <br/<br/> <font style=\"color:green;font-weight:bold;\">Siddhi Vinayaka AgriEssential Store.</font>"
				+ "    </p>" + "    " + "  </body>" + "</html>";
	...
	public static void orderShipped(String recipientEmail, String name, String transId, double transAmount) {
		String recipient = recipientEmail;
		String subject = "Hurray!!, Your Order has been Shipped from Siddhi Vinayaka AgriEssential Store";
		String htmlTextMessage = "<html>" + "  <body>" + "    <p>" + "      Hey " + name + ",<br/><br/>"
				+ "      We are glad that you shop with Siddhi Vinayaka AgriEssential Store!" + "      <br/><br/>"
	...
	public static void productAvailableNow(String recipientEmail, String name, String prodName, String prodId) {
		String recipient = recipientEmail;
		String subject = "Product " + prodName + " is Now Available at Siddhi Vinayaka AgriEssential Store";
		String htmlTextMessage = "<html>" + "  <body>" + "    <p>" + "      Hey " + name + ",<br/><br/>"
				+ "      We are glad that you shop with Siddhi Vinayaka AgriEssential Store!" + "      <br/><br/>"
				...
				+ "      Come Shop Again! <br/<br/><br/> <font style=\"color:green;font-weight:bold;\">Siddhi Vinayaka AgriEssential Store.</font>"
				+ "    </p>" + "    " + "  </body>" + "</html>";
