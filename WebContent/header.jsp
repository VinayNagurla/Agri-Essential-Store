...
<body style="background-color: #E6F9E6;">
	...
	<div class="container-fluid text-center"
		...
		<h2>Siddhi Vinayaka AgriEssential Store</h2>
		...
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="index.jsp"><span
					class="glyphicon glyphicon-home">&nbsp;</span>Agri Store</div>
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown"><a class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							...
							<li><a href="index.jsp?type=seeds">seeds</a></li>
							<li><a href="index.jsp?type=compost">compost</a></li>
							<li><a href="index.jsp?type=soil conditioners">soil conditioners</a></li>
							<li><a href="index.jsp?type=manures">manures</a></li>
						</ul></li>
				</ul>
			</div>
		</div>
		...
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="userHome.jsp"><span
					class="glyphicon glyphicon-home">&nbsp;</span></a>Agri Store</div>
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown"><a class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							...
							<li><a href="userHome.jsp?type=seeds">seeds</a></li>
							<li><a href="userHome.jsp?type=compost">compost</a></li>
							<li><a href="userHome.jsp?type=soil conditioners">soil conditioners</a></li>
							<li><a href="userHome.jsp?type=manures">manures</a></li>
						</ul></li>
					<%
					if (notf == 0) {
					%>
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown"><a class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							...
							<li><a href="adminViewProduct.jsp?type=seeds">seeds</a></li>
							<li><a href="adminViewProduct.jsp?type=compost">compost</a></li>
							<li><a href="adminViewProduct.jsp?type=soil conditioners">soil conditioners</a></li>
							<li><a href="adminViewProduct.jsp?type=manures">manures</a></li>
						</ul></li>
